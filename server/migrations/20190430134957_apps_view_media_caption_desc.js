    ...
    await knex.raw(`
        ...
        CREATE VIEW apps_view AS
            SELECT  app.id AS app_id, 
                    ...
                    media.id AS media_id, media.original_filename, media.uuid AS media_uuid, media.created_at AS media_created_at, media.image_type, media.caption AS media_caption, media.description AS media_description, 
