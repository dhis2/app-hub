...
const NewAppVersionForm = (props) => {
    ...
    return (
        <Form onSubmit={handleSubmit(onSub)}>
            <Field name="version" component={formUtils.renderTextField} autoFocus fullWidth label="Version"/> <br />
...
export default reduxForm({form: 'newAppVersionForm', validate})(NewAppVersionForm);